...
if (isset($_POST['personalinfo'])) {
      ...
      //  $sql = "UPDATE Employee SET `f_name` = '$fname', `l_name` = '$lname', `address` = '$address', `contact_email` = '$email' WHERE `employee_id` = '$user_id';";
        $sql= "UPDATE `Employee` SET `f_name` = '$fname', `l_name` = '$lname', `address` = '$address', `contact_email` = '$email' WHERE (`employee_id` = '$user_id');";
//var_dump($sql);
//var_dump($sql);
...
if (isset($_POST['profileinfo'])) {
    ...
    if ($result->num_rows ==0){
        ...
        $sql2 ="UPDATE Employee SET category='$category' WHERE (`employee_id` = '$user_id');";
  ...
  //  echo $_POST['expY'];
    ...
    $accountn=clean_input($_POST['accountn']);
     ...
     //var_dump($_POST);
      ...
      //update method of payment and credit_info
    $sql1 = " UPDATE Method_of_payment SET withdrawal_type = '$wchecking', priority = '$phecking' WHERE method_id = '$methodidc' AND user_id='$user_id';";
